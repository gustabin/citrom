	...
	?>
														...
														<tr class="cart_table_item">														   
															...
															<td class="product-price">
																<span class="amount"><?php echo $precio?></span>
															</td>
                                                            <td class="product-price">
											...
											<table cellspacing="0" class="cart-totals">
												<tbody>
													<tr class="total">
														...
														<td>
															<strong><span class="amount" style="text-align:right"><?php echo $subTotal ?>&nbsp;Bs</span></strong>
														</td>
													</tr>
													<tr class="total">
														<th>
                                                    ...
                                                    <tr class="total">
                                                        ...
                                                        <?php $iva=$subTotal*0.12 ?>
															<strong><span class="amount" style="text-align:right"><?php echo $iva ?>&nbsp;Bs</span></strong>
														</td>
													</tr>
													<tr class="total">
														<th>
                                                        ...
                                                        <?php $granTotal= $subTotal + $iva ?>
															<strong><span class="amount" style="text-align:right"><?php echo $granTotal ?>&nbsp;Bs</span></strong>
														</td>
													</tr>
												</tbody>
											</table>
