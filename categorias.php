    ...
    <div class="container">
    	<div class="form-group col-md-12">
      		<form  method="post" name="formCategoria" id="formCategoria">
        		<div class="controls">
          			<input type="text" id="categoria" name="categoria" style="width: 20%;"  placeholder="Nombre de la categoria" />	  
        		</div>
            ...
            <div id="sresults" class="col-md-12">
   			<table id="sTable" class="tablesorter table table-bordered table-hover" style="border:1px solid #ECF0F1">
      			<thead>        		
                <tr>                    
                    <th width="90%" class="header" style="text-align: center">Categoría</th>					
