<?php
	...
	if(empty($dataUsuario))
		...
		$asunto = "Recuperar Clave de Citrom, c.a.";
		$cabeceras = "Content-type: text/html"; 
		$cuerpo ="<h1>En Citrom te ayudamos!</h1><br><br>
				...
				<img src=http://www.citrom.com.ve/img/password.jpg /><br>
