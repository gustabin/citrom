...
while($fila=mysql_fetch_array($resultado_consulta_mysql))
    ...
    $productos = $productos ."<tr class=cart_table_item>	 
        <td class=product-thumbnail>
          <a href=http://www.citrom.com.ve/descripcion.php?codProducto=". $codigoProducto ."> 
				<img width=100 height=100 class=img-responsive src=http://www.citrom.com.ve/img/products/" .$foto.">
          
        </td>
        <td class=product-name>
          <a href=http://www.citrom.com.ve/descripcion.php?codProducto=". $codigoProducto .">".$producto."</a>
        </td>
...
<table cellspacing=0 class=shop_table cart>
  <tbody>
	  ...
	  <tr class=total style=text-align:right>
		...
		//$destino ="citrom.ventas@gmail.com";
		
		$destino ="gustabin@yahoo.com";
		$asunto = "Contacto Web www.citrom.com.ve";
		...
		$productos<br>
		<p></p>
		 Tus amigos en citrom.com.ve<br>
