...
-->
 table.page_footer {width: 100%; border: none; background-color: rgb(62,178,229); border-top: solid 1mm rgb(238,238,238); padding: 2mm}
    table.page_header {width: 100%; border: none; background-color: rgb(62,178,229); border-bottom: solid 1mm rgb(238,238,238); padding: 2mm }
.historia {
	font-size: 9px;
}
.grande {
...
<table class="page_header">
            <tr>
                <td style="width: 33%; text-align: left; color:#999">&nbsp;&nbsp;&nbsp; 
                     ...
                     <td style="width: 33%; text-align: center; color:#FFF">&nbsp;&nbsp;&nbsp; 
...
//********** Buscar el id del producto en la tabla PRODUCTOS *********************************************	
	...
	$queryCategoria="SELECT * FROM tbl_categorias WHERE id = $categoria";  

	$resultado=mysql_query($queryCategoria,$dbConn);
...
<table class="page_footer">
            <tr>
                <td style="width: 33%; text-align: left; color:#3E3E3E">
                    &nbsp;&nbsp;&nbsp; <span class="historia">Producto:</span> <?php echo $producto ?>
                </td>
                <td style="width: 34%; text-align: center; color:#3E3E3E">
                    página [[page_cu]]/[[page_nb]]
                </td>
                <td style="width: 33%; text-align: right; color:#3E3E3E">
              Citrom c.a. &nbsp;&nbsp;&nbsp;</td>
            </tr>
        </table>
    </page_footer>
