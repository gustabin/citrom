												...
												<table cellspacing="0" class="shop_table cart">                                                
                                                    ...
                                                    <thead>   
                                                    	<tr>	
															...
															<th>
																Dirección Fiscal  <?php echo $ocultar ?>
															</th>
...
if (empty($_SESSION['direccionCambiar'])) { ?>
...
<div class="row featured-boxes">
             ...
             <div style="float:center; display:none" id="barra"><img src="img/barra.gif" alt="Revisando la información..."/><br>Actualizando....</div>	
										</div>
									</div>
								</div>
							</div>
	...
	?>
														...
														<tr class="cart_table_item">														   
															...
															<td class="product-price">
																<span class="amount"><?php echo number_format($precio, 2, ",", ".");?></span>
															</td>
                                                            <td class="product-price">
...
$descripcion = "Citrom, c.a. " . $_SESSION['nombre'] ." ". $_SESSION['apellido'] ." ". date("d-m-Y H:i"); //esta linea no funciona
