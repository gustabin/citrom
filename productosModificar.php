...
<?php
	...
	while($data_prod=mysql_fetch_array($resultado))
	{
		...
		if (empty($fotoAdicional1)){
			$fotoAdicional1 =  $data_prod['producto'].".jpg";
		}
		
		$fotoAdicional2 = $data_prod['fotoAdicional2'];
		if (empty($fotoAdicional2)){
			$fotoAdicional2 =  $data_prod['producto']."-2.jpg";
		}
		$fotoAdicional3 = $data_prod['fotoAdicional3'];
		if (empty($fotoAdicional3)){
			$fotoAdicional3 =  $data_prod['producto']."-3.jpg";
		}
		//if (empty($fotoAdicional3)) {
			//$fotoAdicional3="producto.gif";
			//}
		$fotoAdicional4 = $data_prod['fotoAdicional4'];
		//if (empty($fotoAdicional4)){
			//$fotoAdicional4 =  $data_prod['producto']."-4.jpg";
		//}
		if (empty($fotoAdicional4)) {
			$fotoAdicional4="producto.gif";
			}
...
?>
    ...
    <h5>Datos del producto</h5>
		<div class="control-group-inline">	 
		  ...
		  Producto <input name="producto" type="text" class="span4 required" id="producto"  maxlength="30" placeholder="producto" style="width: 20%;" value="<?php echo $producto ?>">          
        </div>
        <div class="control-group-inline">
          Código <input name="codigo" type="text" class="span4 required" id="codigo"  maxlength="20" placeholder="codigo" style="width: 20%;" value="<?php echo $codigo ?>">
          ...
          Valoración <input name="valoracion" type="text" class="span4" id="valoracion" value="<?php //echo $valoracion ?>" style="width: 2%;" placeholder="valoracion"!-->
			Precio <input name="precio" type="text" class="span4 required" id="precio"  maxlength="10" placeholder="precio" style="width: 8%;" value="<?php echo $precio ?>">
		</div>       
        <div class="control-group-inline">
          Foto del empaque
            <input name="foto" type="text" class="span4 required" id="foto"  maxlength="40" placeholder="Foto del empaque" style="width: 30%;" value="<?php echo $foto ?>">
          ...
          Foto de la Portada 
          <input name="fotoAdicional1" type="text" class="span4" id="fotoAdicional1"  maxlength="40" placeholder="Foto de la Portada" style="width: 30%;" value="<?php echo $fotoAdicional1 ?>">
        ...
        <div class="control-group-inline">
         Foto Adicional #1 
           <input name="fotoAdicional2" type="text" class="span4" id="fotoAdicional2"  maxlength="40" placeholder="Foto Adicional #1" style="width: 30%;" value="<?php echo $fotoAdicional2 ?>">
          <a href='fotomodificar.php?id=<?php echo $id ?>&foto=foto2&idProd=<?php echo $codigo ?>'>      				
                    <i class="fa fa-pencil-square-o fa-2x" style="cursor: pointer;"></i>
      		</a>
          Foto Adicional #2 
          <input name="fotoAdicional3" type="text" class="span4" id="fotoAdicional3"  maxlength="40" placeholder="Foto Adicional #2" style="width: 30%;" value="<?php echo $fotoAdicional3 ?>">  
        ...
        <div class="control-group-inline">
         Foto Adicional #3 
           <input name="fotoAdicional4" type="text" class="span4" id="fotoAdicional4"  maxlength="40" placeholder="Foto Adicional #3" style="width: 30%;" value="<?php echo $fotoAdicional4 ?>">
...
?>
        ...
        <div class="control-group-inline">
            ...
            <INPUT TYPE="NUMBER" MIN="0" MAX="9000" STEP="1" VALUE="<?php echo $cantidad ?>" name="cantidad" id="cantidad" style="width: 5%;" >
	  		Categoria 
