  ...
  <section class="section-content section-contact section-color-graylighter">
    ...
    <h5>Datos del producto</h5>
		<div class="control-group-inline">	 
		  Producto <input name="producto" type="text" class="span4 required" id="producto"  maxlength="30" placeholder="producto" style="width: 20%;" value="">        </div>
        <div class="control-group-inline">
          Código <input name="codigo" type="text" class="span4 required" id="codigo"  maxlength="20" placeholder="codigo" style="width: 20%;" value="">
          ...
          Valoración <input name="valoracion" type="text" class="span4" id="valoracion" value="" style="width: 2%;" placeholder="valoracion"!-->
			Precio <input name="precio" type="text" class="span4 required" id="precio"  maxlength="11" placeholder="precio" style="width: 7%;" value="">
		</div>
        ...
        <div class="control-group-inline">
            ...
            <INPUT TYPE="NUMBER" MIN="0" MAX="9000" STEP="1" name="cantidad" id="cantidad" style="width: 5%;" >
	  		Categoria  
